...
<main id="main" class="main">
  ...
  <?php $clinic_info = mysqli_query($confg, contactView('El-Badrashin'));
  $info = []; ?>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="info-box card">
              ...
              <h3>Open Hours</h3>
              <p><?= $info[0]['day']?> - <?= $info[1]['day']?> - <?= $info[2]['day']?><br><?= date('g:ia',strtotime($info[0]['START_AT']))?> - <?= date('g:ia',strtotime($info[0]['END_AT']))?> </p>
            </div>
          </div>
        </div>
